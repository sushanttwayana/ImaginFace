...
#         bbox_path = os.path.join(data_dir, 'Celeba_10000/bounding_boxes.txt')
...
#                                         )
#         #
#         filepath = os.path.join(data_dir, 'Celeba_10000/images.txt')
#         df_filenames = \
...
#         print(f'Attempting to access caption index: {sent_ix}')
#         print(f'Total captions available: {len(self.captions)}')
...
class TextImgDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        #----------------------------------------------------------------
        # # Add a print statement to debug the index
        # print(f"Fetching index {index}")
        # caps, cap_len = self.get_caption(new_sent_ix)
        # # Add a print statement to debug the caption index
        # print(f"Caption index: {new_sent_ix}")
